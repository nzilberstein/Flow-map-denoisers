...
# # DPS ODe
CUDA_VISIBLE_DEVICES=7 python run_baselines.py --model afhq --method dps \
        --degradation deblurring_gaussian --blur_kernel_size 61 --blur_std 3.0 --sr_factor 4 \
        --num_steps 100 --sigma_noise 5e-2 --dps_eta 0.1e3 \
        --num_batches 20
...
#     --degradation deblurring_gaussian --blur_kernel_size 61 --blur_std 3.0 \
#     --lookahead 1 --alpha 0.05 --num_steps 100 --sigma_noise 10e-2 --gain 1.0 \
#     --num_batches 20 --batch_size 1
